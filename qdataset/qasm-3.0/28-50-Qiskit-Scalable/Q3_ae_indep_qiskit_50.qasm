...
cx eval[43],q[0];
U(-8156574996590.827,0,0) q[0];cx eval[43],q[0];
u3(1.1905829912517445,0,0) q[0];
cx eval[44],q[0];
U(-16313149993181.654,0,0) q[0];cx eval[44],q[0];
u3(2.3811659825034885,0,0) q[0];
cx eval[45],q[0];
U(-32626299986363.31,0,0) q[0];cx eval[45],q[0];
u3(1.520853342172609,-pi,-pi) q[0];
cx eval[46],q[0];
U(-65252599972726.62,0,0) q[0];cx eval[46],q[0];
u3(3.041706684345218,-pi,-pi) q[0];
cx eval[47],q[0];
U(-130505199945453.23,0,0) q[0];cx eval[47],q[0];
u3(0.19977193848915115,0,0) q[0];
cx eval[48],q[0];
U(-261010399890906.47,0,0) q[0];cx eval[48],q[0];
U(261010399890906.47,0,0) q[0];h eval[48];
...
meas[43] = measure eval[43];
meas[44] = measure eval[44];
meas[45] = measure eval[45];
meas[46] = measure eval[46];
meas[47] = measure eval[47];
meas[48] = measure eval[48];
meas[49] = measure q[0];