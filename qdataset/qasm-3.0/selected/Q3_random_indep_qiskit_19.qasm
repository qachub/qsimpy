...
u2(3*pi/4,-pi) q[9];
swap q[9],q[10];
U(1.3747010518474199,3.464488948976134,1.9778249211971906) q[10];crx(1.0696826440846487) q[10],q[2];
...
cu1(pi/2) q[8],q[7];
u2(0,-pi) q[7];
U(4.058201861681506,5.462350466904767,3.604249152724086) q[8];swap q[9],q[13];
...
sx q[5];
cz q[8],q[5];
U(0.8901937417458883,3.1960073615158335,5.194087345152503) q[5];u1(-pi/2) q[8];
cx q[15],q[8];
cx q[8],q[15];
u2(0,0) q[15];
cx q[15],q[14];
