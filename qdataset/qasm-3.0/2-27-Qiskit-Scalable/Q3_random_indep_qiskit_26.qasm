...
u3(1.0718324596949644,1.3202063535007813,-1.5755759906735092) q[15];
h q[16];
cx q[2],q[16];
h q[16];
cu1(pi/2) q[2],q[16];
u3(1.1818462925295137,1.4736681111362318,-2.6813472704135473) q[16];
u3(2.414222725344413,-0.7516799720162921,2.9499261817427715) q[2];
cx q[17],q[12];
tdg q[12];
cx q[9],q[18];
cx q[18],q[8];
...
cx q[9],q[19];
u3(pi,1.0318717917839741,-1.0318717917839741) q[19];
u2(-pi,-pi) q[9];
cy q[9],q[11];
cx q[20],q[12];
t q[12];
...
u3(0.4302473284559397,-2.2653334945152297,0.6675377269060689) q[7];
...
s q[24];
cx q[24],q[4];
u3(1.9783085351545655,1.767149438045971,-2.787781423392139) q[24];
u1(-0.48445832423989366) q[25];
cx q[25],q[23];
h q[23];
cu1(pi/2) q[25],q[23];
cu3(0.31255756991058886,5.0501120034353315,1.59281100396259) q[23],q[25];
u3(2.4472920620965244,-0.3338520715950035,0.5915207724126752) q[23];
cx q[24],q[23];
...
cx q[11],q[2];
u2(pi/4,3*pi/4) q[2];
u2(0,-2.9558769352004264) q[20];
cx q[8],q[2];
u2(0,3*pi/4) q[2];
cswap q[18],q[2],q[13];
z q[13];
U(5.995865513716156,3.2145609627525853,1.6556110685025274) q[18];cx q[18],q[20];
...
cx q[20],q[2];
h q[2];
u3(0.6869119622693339,-pi/2,0.3003241747289471) q[20];
u2(-pi/2,-pi) q[21];
cu1(pi/2) q[14],q[21];
h q[21];
...
rx(-pi/2) q[17];
u3(1.221673815896782,1.5771040939421326,2.1994183904937206) q[2];
u3(2.9457486239816713,-2.8961219195713803,-2.865855140036094) q[8];
...
cx q[23],q[3];
rx(pi/2) q[23];
u3(1.0919409711161563,1.4328784108063966,-2.347502867965349) q[3];
cu3(1.7314272300100533,4.219818012571217,5.504196595741835) q[19],q[3];
u2(pi/4,-pi) q[19];
u2(pi/4,-pi) q[3];
rzz(0.10112592125382325) q[4],q[23];
u3(2.0041793349611705,-1.796394497401653,2.235890013312174) q[23];
rx(-pi/2) q[4];
cry(1.2418576747663082) q[21],q[4];
rx(pi/2) q[21];
cz q[4],q[7];
rx(4.360549423921112) q[7];
u3(1.3471877187594674,-0.16389055443523315,-2.1876841657926587) q[8];
cz q[9],q[16];
cu1(pi/2) q[16],q[24];
x q[16];
cx q[10],q[16];
...
u2(-pi/2,-0.15467644138350867) q[25];
rzz(5.720342519357437) q[25],q[21];
u3(pi,0,-pi/2) q[21];
cx q[21],q[12];
cx q[12],q[21];
u2(0.14296669617652302,-pi) q[12];
y q[21];
rx(-pi/2) q[25];
swap q[25],q[13];
h q[5];
cu1(5.571209279110489) q[24],q[5];
u3(1.187083234121178,-3.0819247803106062,2.0774834695217503) q[5];
...
cx q[0],q[3];
u2(pi/2,-3*pi/4) q[3];
u3(2.3089346320736146,-0.08468554758471125,1.3525923031544096) q[4];
u2(0,0) q[9];
cx q[9],q[10];
...
u1(-pi/4) q[8];
cx q[18],q[8];
u3(1.4766266737272302,pi/2,pi/2) q[18];
u1(pi/4) q[8];
cx q[14],q[8];
s q[14];
cx q[19],q[14];
...
U(3.8715265710290208,0.8200245535364928,6.18274889943543) q[15];cu1(pi/8) q[15],q[4];
tdg q[25];
cz q[12],q[25];
...
cx q[10],q[19];
cx q[19],q[10];
u3(pi,0.005934884132742457,-0.005934884132742457) q[10];
h q[19];
sx q[21];
ccx q[23],q[17],q[5];
h q[17];
...
h q[17];
cu1(pi/2) q[22],q[17];
u3(1.4336491230699635,-2.2695112672764335,1.5789809279865246) q[17];
...
u2(0,3*pi/4) q[14];
u3(0.19882343437051853,-1.3353385716340573,-pi/2) q[2];
h q[24];
u2(0,-pi) q[4];
u2(0,0) q[7];
cx q[7],q[22];
...
cx q[7],q[22];
u2(-pi/2,-1.0259687058538076) q[22];
...
cu1(pi/2) q[22],q[15];
u3(1.8222773190389807,1.040355013452718,0.27900579808480375) q[15];
cy q[23],q[8];
cx q[19],q[8];
sxdg q[19];
...
s q[14];
u3(2.3027319888609585,-pi/2,2.322048087411968) q[19];
cu1(pi/2) q[21],q[13];
sx q[21];
swap q[24],q[0];
u2(0,-pi/2) q[0];
...
u2(2.357490713474159,pi/2) q[24];
...
sx q[25];
u3(0.7141828555711861,-pi/2,0) q[5];
cy q[6],q[16];
...
t q[18];
cx q[16],q[18];
U(2.7482500772391254,6.219213711951733,1.3273941574270594) q[16];u3(0.10757851012128583,2.5848996599613034,1.799501496563856) q[18];
cswap q[20],q[1],q[12];
...
cx q[23],q[2];
u2(0,0) q[2];
U(1.7798622900765144,5.111304365132587,0.4953372067845129) q[5];cz q[6],q[16];
rx(pi/2) q[16];
rzz(1.3203486354268206) q[20],q[16];
u3(1.1566312035338253,2.6071098144004337,-1.6285536020573126) q[16];
rx(-pi/2) q[20];
s q[6];
...
s q[4];
cx q[4],q[25];
u1(-1.6252110347209368) q[25];
u3(0.2934926634958971,0.7194093445432141,0.41542648101806323) q[4];
...
sx q[1];
U(3.2016854072863508,5.7173174641036475,6.099677243463139) q[5];cx q[6],q[17];
x q[17];
cswap q[21],q[17],q[3];
u2(pi/4,-pi) q[17];
cx q[13],q[17];
...
u3(2.579990181908615,3.0732641567518986,0.0941686925339349) q[3];
h q[6];
cx q[6],q[19];
...
cx q[22],q[25];
u2(-1.1936261528567127,-pi) q[22];
u1(1.6252110347209365) q[25];
cz q[16],q[25];
rx(-pi/2) q[9];
...
s q[22];
swap q[22],q[14];
u3(0.6861414703339438,pi/2,0) q[14];
h q[6];
cu1(pi/8) q[16],q[6];
cx q[16],q[7];
cu1(-pi/8) q[7],q[6];
...
u2(pi/2,-1.6125278487819812) q[12];
...
u1(-3.070573010079518) q[20];
u2(pi/4,-pi) q[25];
u3(1.1277692905635301,-2.036210751311023,-3.0207194319527675) q[3];
ch q[4],q[9];
ccx q[4],q[5],q[22];
cp(5.620902208377852) q[10],q[5];
u2(0,-1.1505711019554972) q[10];
swap q[22],q[4];
cx q[6],q[25];
tdg q[25];
cx q[2],q[25];
u3(0.3922785528184719,-1.3144868505349958,-2.5981168942193666) q[2];
t q[25];
cx q[6],q[25];
swap q[1],q[6];
ccx q[1],q[22],q[6];
...
x q[11];
ccx q[11],q[1],q[25];
u3(1.1820290879777702,-0.8332104475463993,-2.2401314156533583) q[1];
u2(pi/4,-pi) q[11];
u2(0,0) q[3];
h q[7];
ccx q[24],q[8],q[7];
...
cx q[16],q[24];
u3(1.5166813274075654,-0.4321081097551178,-pi/2) q[16];
...
U(1.0748330612266623,0.07780435658085334,1.4096355722729612) q[5];u2(-pi,-pi) q[9];
cx q[9],q[21];
...
cx q[23],q[21];
u3(1.688240918899987,2.3126746154788496,-1.659549730631363) q[21];
...
u2(0,0) q[13];
u3(1.8107929061109147,1.3477184200296257,-3.067898848493037) q[22];
u2(0,-pi/2) q[4];
...
s q[10];
cx q[4],q[2];
u3(0.8498985911366346,-1.2312093127018229,-0.07922934402719317) q[2];
cx q[5],q[17];
cx q[17],q[5];
rx(3.283609470644117) q[5];
u2(-0.4462043271710545,-2.3596326474184526) q[6];
cx q[9],q[0];
u1(pi/4) q[0];
cx q[15],q[0];
u1(-pi/4) q[0];
...
ch q[20],q[13];
u3(2.767250792954079,0.2861300067284116,0.195722548611847) q[13];
y q[9];
cx q[9],q[21];
h q[21];
cu1(pi/2) q[9],q[21];
...
u3(0.8875581608376196,0,-pi/2) q[23];
u2(0,-pi/2) q[3];
cx q[3],q[1];
cx q[1],q[3];
u2(0,-pi) q[1];
...
cswap q[15],q[22],q[2];
ccx q[21],q[25],q[11];
u3(2.4073805414313507,0.47014658061229175,-1.3257136214905998) q[11];
s q[21];
sx q[25];
cx q[21],q[25];
x q[21];
...
u3(0.5814047959098211,1.02183951203574,0.07038087554841432) q[8];
cx q[18],q[8];
...
u2(-pi,-pi) q[13];
u1(-1.0828389661190254) q[23];
u3(1.1472579042943556,1.2583529301464456,0) q[5];
u2(0,3*pi/4) q[9];
...
cx q[25],q[13];
cx q[13],q[25];
u3(0.18215780725411906,1.784456040413282,0) q[13];
u2(0,-pi/2) q[4];
...
ccx q[1],q[24],q[19];
u2(0.18698063957366262,-pi/2) q[1];
cu1(pi/8) q[1],q[16];
s q[19];
sx q[6];
cx q[18],q[6];
...
cx q[2],q[20];
ch q[10],q[2];
u3(1.9762580037009196,-pi/2,pi/2) q[2];
u2(pi/4,3*pi/4) q[20];
cx q[18],q[20];
cx q[18],q[11];
u1(pi/4) q[11];
...
u1(0.46767821306971014) q[15];
cx q[10],q[15];
ry(0.2461455889632092) q[10];
ry(-0.2461455889632092) q[15];
cx q[10],q[15];
u2(-pi,-pi) q[10];
u2(0,2.6739144405200825) q[15];
h q[3];
u2(0,0) q[9];
cx q[9],q[5];
...
s q[25];
cx q[25],q[19];
u3(pi,0.750046309261402,-0.7500463092614016) q[19];
u3(pi,-0.13074729793465245,0.13074729793465245) q[25];
h q[3];
cy q[3],q[17];
cswap q[17],q[2],q[5];
...
cx q[24],q[1];
cu1(pi/8) q[1],q[0];
U(5.3183823625334234,4.786805999708144,3.4933396306610422) q[1];rx(2.736573856531224) q[24];
...
U(5.736801117769944,3.0737714321146137,1.2053112992092465) q[6];cu1(pi/2) q[6],q[5];
...
ccx q[22],q[20],q[8];
h q[8];
u3(0.9010555429975509,-2.5719081831830852,pi/2) q[9];
cx q[10],q[9];
cu1(-pi/8) q[9],q[15];
cx q[11],q[9];
cu1(pi/8) q[9],q[15];
