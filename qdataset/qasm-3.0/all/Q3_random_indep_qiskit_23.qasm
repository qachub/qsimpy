...
bit[23] meas;
s q[0];
u3(0.8273367870085525,1.8123796431393568,2.7924663036203192) q[1];
...
h q[12];
cu1(pi/2) q[5],q[12];
u2(-2.3503966855988057,2.355329284762364) q[5];
...
h q[15];
cu1(pi/2) q[16],q[15];
u3(2.648645396816742,-1.8803338899102986,1.8803338899102986) q[15];
h q[16];
cx q[10],q[16];
h q[16];
cu1(pi/2) q[10],q[16];
...
u2(-1.6643787200110325,0) q[0];
u3(1.2422612462072473,-0.8636722785573463,-0.26903848232790883) q[20];
cu1(pi/8) q[7],q[1];
cx q[7],q[10];
cu1(-pi/8) q[10],q[1];
cx q[7],q[10];
...
tdg q[17];
cx q[13],q[17];
u3(pi,0.4276073250373935,-0.4276073250373935) q[13];
cx q[0],q[13];
...
cx q[19],q[12];
cu1(pi/8) q[12],q[9];
u3(1.8642439256652672,0,pi/2) q[12];
cx q[12],q[22];
u2(-pi/2,pi/2) q[12];
ccx q[2],q[19],q[3];
rx(pi/2) q[19];
...
u3(pi,0.6190209529629649,-0.6190209529629649) q[8];
...
u3(1.716213186904181,-0.7095547890652609,0.2650312150537566) q[8];
u2(pi/2,-pi) q[9];
cy q[9],q[21];
cz q[21],q[17];
cu1(pi/2) q[17],q[1];
u1(0.48267074254546927) q[1];
ccx q[17],q[3],q[4];
cy q[19],q[17];
u3(1.5682870707732905,-0.0018345550086289464,-3.141590351903839) q[17];
u3(3.0998682664225266,3.1387681629748476,3.0452133821518217) q[19];
...
u3(0.7843112114751609,2.6503166640089457,1.90343053387239) q[11];
...
cx q[12],q[5];
u2(-pi,-pi) q[12];
u3(2.625546432473971,-1.1154915110524266,1.7737363110944626) q[5];
cx q[20],q[5];
tdg q[5];
cx q[7],q[12];
...
u3(1.8195056778111203,-0.5397986562591219,-0.6494785687662201) q[2];
u2(pi/4,-pi) q[8];
cx q[12],q[8];
tdg q[8];
cx q[5],q[8];
...
u3(1.1530352081930877,1.3174791765139977,2.821063786643464) q[16];
rx(-pi/2) q[6];
cx q[6],q[7];
u1(pi/4) q[7];
cx q[10],q[7];
...
cx q[17],q[13];
u3(1.173682714873175,1.1023225123443527,-1.4452027801697676) q[13];
crz(0.4413226390369919) q[16],q[13];
u2(-pi,-pi) q[17];
rzz(0.12574600318265342) q[2],q[13];
y q[2];
rzz(2.21879255497351) q[22],q[17];
u3(2.6493666002558065,0.550869664113967,pi/4) q[7];
...
u3(2.2881375084599633,-2.805264955012211,0) q[2];
s q[21];
h q[22];
u2(-pi,-pi) q[6];
...
cx q[15],q[2];
u3(1.9116669310624008,0,0) q[15];
...
cx q[19],q[11];
u2(-pi/2,-pi/4) q[11];
u3(1.4795107481915721,-2.686786509314665,0.7440014409906013) q[19];
...
u2(-pi/2,-pi/2) q[19];
ccx q[7],q[3],q[8];
u3(0.7251650287691657,0.8105384911796483,-1.3138898141748965) q[3];
swap q[7],q[0];
s q[0];
...
cu1(pi/2) q[16],q[18];
u3(2.3185564904513005,1.107355751450295,0.6411950566959979) q[16];
...
U(0.08893335220964431,5.7112830423761975,0.8735072073371047) q[2];h q[22];
cx q[3],q[22];
rz(2.3661455902582555) q[22];
cx q[3],q[22];
u2(0,-pi) q[22];
U(2.1884883783102658,4.9270092916743105,2.9201654642896124) q[3];cu1(pi/2) q[9],q[4];
cx q[4],q[20];
tdg q[20];
cx q[9],q[20];
t q[20];
...
u3(1.4450545710058624,pi/2,0) q[14];
cx q[14],q[4];
...
t q[20];
h q[3];
u2(2.0060862754419126,-pi/2) q[6];
...
cx q[18],q[8];
u3(2.7395975925206515,-1.483201825181401,-1.5803205466192642) q[18];
...
cx q[9],q[6];
u1(-0.43528994864701565) q[6];
cswap q[6],q[21],q[1];
cz q[1],q[16];
u2(-pi/2,0) q[16];
t q[21];
u1(-2.263077598501537) q[6];
cx q[6],q[14];
u2(pi/4,-pi) q[14];
u2(-pi,-pi) q[9];
...
cx q[18],q[3];
h q[18];
u3(pi,1.3672757304038932,-1.3672757304038932) q[3];
h q[5];
cx q[6],q[14];
t q[14];
cx q[4],q[14];
u2(0,3*pi/4) q[14];
U(2.0864092063225748,5.6219269491717485,5.962987580869692) q[9];cswap q[9],q[8],q[1];
...
U(5.938330138616645,4.462849822528038,5.821069680599746) q[16];cx q[16],q[18];
...
U(2.482778569932634,1.4243841952904288,1.2668398253185111) q[1];u3(1.0260721899431513,pi/2,pi/2) q[14];
x q[2];
cy q[7],q[20];
u3(1.356279935830272,1.768996848662808,1.5727967572899617) q[20];
s q[8];
ch q[13],q[8];
u3(1.4033262221591387,-2.6966036507860576,-2.4311035979457154) q[13];
cx q[9],q[5];
h q[5];
cu1(pi/2) q[9],q[5];
ch q[17],q[5];
...
cx q[15],q[20];
u3(1.7063539619377697,-2.6902164317046413,0.1312912125492991) q[15];
u1(2.950482321250419) q[20];
u2(0,-3*pi/4) q[22];
ry(-2.424485321091562) q[3];
cx q[19],q[3];
u2(-pi,-pi) q[19];
u1(0.4070411927820059) q[3];
ccx q[20],q[3],q[19];
...
cz q[16],q[19];
u3(1.1509682119111675,0.46614547319897603,-0.8899019986210739) q[16];
...
U(5.923491950473281,0.7130089253650558,2.841187265505522) q[5];ch q[5],q[12];
...
cx q[7],q[6];
u2(0,3*pi/4) q[6];
u3(pi,-2.686820339934697,2.6868203399346964) q[8];
crx(3.8401563055713464) q[8],q[15];
u3(1.7854173824182749,-1.4962055807776289,-2.0634376851276937) q[8];
...
cx q[1],q[17];
u1(-pi/4) q[17];
u3(0.678129896579755,-2.4255923980547283,2.701794875459509) q[2];
ccx q[22],q[1],q[17];
h q[17];
...
u2(-pi/2,-pi/2) q[13];
u2(1.4253693460199743,-pi/2) q[18];
u3(1.3267410422955266,0.0936496424033173,-0.89284665655298) q[9];
cx q[4],q[9];
cx q[9],q[4];
x q[4];
cy q[4],q[18];
...
u3(2.9767681483968285,1.6919775901754956,-pi/2) q[13];
...
cx q[4],q[12];
tdg q[12];
u3(1.8372882095991316,-2.0108429338570657,2.0108429338570657) q[7];
h q[9];
cu1(pi/8) q[10],q[9];
cx q[10],q[21];
cu1(-pi/8) q[21],q[9];
