...
cx q[0],q[18];
ry(4.48981206311071) q[0];
cx q[1],q[18];
ry(3.40890680158139) q[1];
cx q[0],q[1];
cx q[2],q[18];
ry(0.893280754210937) q[2];
cx q[0],q[2];
cx q[1],q[2];
cx q[3],q[18];
ry(2.34576917812665) q[3];
cx q[0],q[3];
cx q[1],q[3];
cx q[2],q[3];
cx q[4],q[18];
ry(4.23570642526072) q[4];
cx q[0],q[4];
cx q[1],q[4];
cx q[2],q[4];
cx q[3],q[4];
cx q[5],q[18];
ry(2.77611970975908) q[5];
cx q[0],q[5];
cx q[1],q[5];
cx q[2],q[5];
cx q[3],q[5];
...
cx q[9],q[18];
cx q[10],q[18];
ry(3.77643912107403) q[10];
cx q[11],q[18];
ry(5.05936655933969) q[11];
cx q[12],q[18];
ry(3.27760572345175) q[12];
cx q[13],q[18];
ry(5.7092092972822) q[13];
cx q[14],q[18];
ry(2.0058195038543) q[14];
cx q[15],q[18];
ry(0.568372854235992) q[15];
cx q[16],q[18];
ry(1.88935417772466) q[16];
cx q[17],q[18];
ry(0.716184867709297) q[17];
ry(5.20675833379049) q[18];
ry(4.0865660173428) q[9];
cx q[0],q[9];
cx q[0],q[10];
cx q[0],q[11];
cx q[0],q[12];
...
cx q[9],q[18];
cx q[10],q[18];
ry(1.91926127086387) q[10];
cx q[11],q[18];
ry(2.07797072184667) q[11];
cx q[12],q[18];
ry(4.86211914740084) q[12];
cx q[13],q[18];
ry(0.251071112927388) q[13];
cx q[14],q[18];
ry(2.69857894507022) q[14];
cx q[15],q[18];
ry(1.97874389399801) q[15];
cx q[16],q[18];
ry(3.99919179827194) q[16];
cx q[17],q[18];
ry(2.17616332456639) q[17];
ry(0.270788675285506) q[18];
ry(0.500223798327118) q[9];
