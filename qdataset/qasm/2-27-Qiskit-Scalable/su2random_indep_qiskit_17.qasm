...
cx q[2],q[4];
cx q[3],q[4];
u3(1.4124389803026798,2.345769178126651,0) q[5];
cx q[0],q[5];
cx q[1],q[5];
cx q[2],q[5];
cx q[3],q[5];
cx q[4],q[5];
u3(1.2444656817555668,-2.0474788819188667,0) q[6];
cx q[0],q[6];
cx q[1],q[6];
cx q[2],q[6];
cx q[3],q[6];
cx q[4],q[6];
cx q[5],q[6];
u3(1.5046299106322627,-0.36547294383070916,-pi) q[7];
cx q[0],q[7];
cx q[1],q[7];
cx q[2],q[7];
cx q[3],q[7];
...
cx q[5],q[7];
cx q[6],q[7];
u3(1.0625547235745711,2.72699034602209,0) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[6],q[8];
cx q[7],q[8];
u3(0.5550554224571163,-2.401640904800445,0) q[9];
cx q[0],q[9];
cx q[1],q[9];
cx q[2],q[9];
cx q[3],q[9];
...
cx q[1],q[2];
cx q[3],q[16];
u3(1.0764269733891,-0.7281303932915777,-pi) q[3];
cx q[0],q[3];
cx q[1],q[3];
cx q[2],q[3];
cx q[4],q[16];
...
cx q[4],q[5];
cx q[6],q[16];
u3(2.842600017892846,-0.2745466276846109,-pi) q[6];
cx q[0],q[6];
cx q[1],q[6];
cx q[2],q[6];
cx q[3],q[6];
...
cx q[6],q[7];
cx q[8],q[16];
u3(1.2500242582094414,1.5794302666547848,0) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[15],q[16];
u3(1.0368254640000032,0.5002237983271178,0) q[15];
...
cx q[1],q[15];
cx q[1],q[16];
u3(1.4210661597787437,-1.2373944253509892,-pi) q[1];
cx q[0],q[1];
cx q[2],q[9];
cx q[2],q[10];
cx q[2],q[11];
...
cx q[2],q[15];
cx q[2],q[16];
u3(0.25107111292738793,1.5210075835580792,0) q[2];
cx q[0],q[2];
cx q[1],q[2];
cx q[3],q[9];
cx q[3],q[10];
...
cx q[4],q[15];
cx q[4],q[16];
u3(1.9787438939980078,-2.7299999087113385,0) q[4];
cx q[0],q[4];
cx q[1],q[4];
cx q[2],q[4];
cx q[3],q[4];
...
cx q[9],q[16];
cx q[10],q[16];
u3(0.7659413833270341,-0.03111036968978631,-pi) q[10];
cx q[11],q[16];
u3(2.6232873181840106,-0.1440060461338284,0) q[11];
cx q[12],q[16];
u3(2.4782292522231346,-0.3721290331845779,-pi) q[12];
cx q[13],q[16];
u3(3.0569793381207737,-1.1418256385296206,-pi) q[13];
cx q[14],q[16];
u3(2.526866864605136,0.12438813077863031,-pi) q[14];
cx q[15],q[16];
u3(1.6475495893366512,-2.650646985396806,0) q[15];
u3(1.8904301876881415,-0.9177613127301711,0) q[16];
u3(1.4876032641952892,-1.0071453217107083,-pi) q[9];
cx q[0],q[9];
cx q[0],q[10];
cx q[0],q[11];
cx q[0],q[12];
...
cx q[3],q[15];
cx q[3],q[16];
u3(1.7680706872878738,-2.470048419290659,-pi) q[3];
cx q[4],q[9];
cx q[4],q[10];
cx q[4],q[11];
cx q[4],q[12];
...
cx q[9],q[16];
cx q[10],q[16];
u3(2.051667817359218,-2.8360538791181265,-pi) q[10];
cx q[11],q[16];
...
cx q[14],q[16];
u3(0.6789847093662497,2.396479352101599,0) q[14];
cx q[15],q[16];
u3(1.1240794982270375,-0.4886258107079424,0) q[15];
