...
u2(-3*pi/4,-pi) q[7];
u2(pi/4,-pi) q[11];
u3(0.720331751888824,-pi/2,0) q[12];
...
u3(1.661361073660491,-0.0008369135642456449,0.9222820124197781) q[19];
u2(-pi/2,-pi) q[2];
...
cu1(pi/2) q[15],q[13];
h q[13];
u3(1.4584043828862834,-0.993237818726572,3.068632405354201) q[15];
cx q[17],q[11];
u2(0,3*pi/4) q[11];
...
cu1(pi/2) q[0],q[17];
u3(pi,1.722677257634592,-1.7226772576345915) q[0];
u2(-pi/4,-pi) q[17];
cx q[19],q[11];
cx q[11],q[19];
u3(1.8601652760268672,-0.04695821192438876,2.278529910150091) q[11];
u3(1.6510248685052311,0.482231809575167,2.3701997824818317) q[19];
ccx q[9],q[2],q[4];
u3(pi,-1.0175476642181374,1.017547664218137) q[2];
h q[4];
ccx q[18],q[4],q[8];
ch q[1],q[8];
...
cu1(pi/8) q[16],q[7];
u3(1.702839812682634,2.2050133174391373,2.81637238812469) q[19];
cx q[3],q[14];
u2(0,3*pi/4) q[14];
...
cx q[15],q[6];
tdg q[6];
u3(1.5630823335246644,0.8041660200438789,pi/4) q[9];
cx q[9],q[0];
u1(-pi/4) q[0];
cx q[7],q[0];
u1(pi/4) q[0];
...
u2(pi/4,3*pi/4) q[0];
cx q[8],q[0];
u3(1.629835101519424,2.600739509561226,-0.6874682137425956) q[0];
cx q[17],q[0];
h q[0];
cu1(pi/2) q[17],q[0];
cz q[0],q[6];
...
u2(-0.23606453599076804,-pi/2) q[4];
u2(-pi,-pi) q[8];
...
cu1(pi/2) q[11],q[10];
cx q[10],q[5];
u2(-1.4452981857884435,-pi) q[11];
rz(4.607707280570853) q[5];
cx q[10],q[5];
cx q[10],q[4];
u2(0,0) q[10];
h q[4];
u3(0.7304560762453086,pi/2,-pi/2) q[5];
cu1(pi/8) q[7],q[16];
h q[16];
...
u3(0.634664145177297,-0.421907988815716,0.4761810065817418) q[7];
cx q[16],q[7];
ry(0.6611680898285344) q[16];
ry(-0.6611680898285344) q[7];
cx q[16],q[7];
u3(1.1014990646814273,-1.818030905745101,-0.45785652784809816) q[16];
u1(-1.45426759176396) q[7];
swap q[7],q[6];
cx q[8],q[0];
u1(pi/4) q[0];
cx q[2],q[0];
...
u1(0.11650640661107214) q[18];
cx q[13],q[18];
u3(1.4499316212221933,2.0795655506484145,-1.7325095417801688) q[13];
...
cx q[10],q[0];
u3(2.5400564533316072,-pi/2,-3.058124521711181) q[0];
u2(-pi,-pi) q[10];
cu1(pi/2) q[10],q[6];
cy q[10],q[18];
u2(pi/2,-pi) q[12];
...
tdg q[1];
u3(1.6274964540763421,-2.253165754740676,0.5651197384932378) q[13];
u3(2.205958726059214,0.009951100065911156,-3.0158508978007585) q[15];
cswap q[17],q[9],q[2];
...
u2(0,0) q[12];
cu1(pi/2) q[15],q[2];
u2(-0.22443708567201037,-3.133113135316627) q[2];
rzz(5.4209241862562445) q[5],q[17];
u3(1.1546967471332699,-2.2837686868088722,1.262608779687957) q[17];
u3(2.150223982882464,1.2895449798515601,-1.762160387191038) q[5];
...
cx q[12],q[5];
u3(1.483416135756464,-2.3039199562574018,0.19577890116319985) q[12];
u1(-1.9862228078129611) q[5];
u2(pi/2,-pi) q[6];
cx q[3],q[6];
...
u3(0.128410962345374,0.3006809799587611,-0.07773417540472716) q[7];
cx q[12],q[7];
u2(0,3*pi/4) q[7];
cx q[15],q[7];
u1(pi/4) q[7];
...
u3(0.9884020281573046,-1.2661125627002352,1.9015387643576496) q[18];
cu1(pi/2) q[2],q[13];
h q[13];
z q[2];
...
h q[15];
s q[19];
u3(1.456297291592631,-1.1898955138310718,2.3535915169092636) q[7];
u1(1.8642889902907935) q[8];
t q[9];
ccx q[3],q[6],q[9];
...
u3(0.8004445919394361,0,pi/2) q[13];
u2(0,3*pi/4) q[18];
cu1(pi/8) q[3],q[8];
