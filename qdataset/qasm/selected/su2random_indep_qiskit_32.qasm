...
cx q[3],q[5];
cx q[4],q[5];
u3(1.2444656817555668,0.29465826494733527,0) q[6];
cx q[0],q[6];
cx q[1],q[6];
cx q[2],q[6];
cx q[3],q[6];
...
cx q[5],q[7];
cx q[6],q[7];
u3(1.0625547235745711,-2.8426000178928454,0) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[6],q[8];
cx q[7],q[8];
u3(0.5550554224571164,-1.1354532936221062,0) q[9];
cx q[0],q[9];
cx q[1],q[9];
cx q[2],q[9];
cx q[3],q[9];
...
cx q[9],q[11];
cx q[10],q[11];
u3(0.02480768898038398,2.2094986973106154,0) q[12];
cx q[0],q[12];
cx q[1],q[12];
cx q[2],q[12];
cx q[3],q[12];
...
cx q[11],q[13];
cx q[12],q[13];
u3(1.1773372206208808,-1.2820104054356045,-pi) q[14];
cx q[0],q[14];
cx q[1],q[14];
cx q[2],q[14];
cx q[3],q[14];
...
cx q[16],q[18];
cx q[17],q[18];
u3(1.7933732440688746,-2.554363801359381,-pi) q[19];
cx q[0],q[19];
cx q[1],q[19];
cx q[2],q[19];
cx q[3],q[19];
...
cx q[18],q[20];
cx q[19],q[20];
u3(0.8932807542109366,0.9497161489686778,0) q[21];
cx q[0],q[21];
cx q[1],q[21];
cx q[2],q[21];
cx q[3],q[21];
...
cx q[20],q[22];
cx q[21],q[22];
u3(2.047478881918867,2.7913723796959733,-pi) q[23];
cx q[0],q[23];
cx q[1],q[23];
cx q[2],q[23];
cx q[3],q[23];
...
cx q[26],q[28];
cx q[27],q[28];
u3(2.5067461861055573,2.5310665977809697,-pi) q[29];
cx q[0],q[29];
cx q[1],q[29];
cx q[2],q[29];
cx q[3],q[29];
...
cx q[27],q[29];
cx q[28],q[29];
u3(1.223818747839898,0.2171339961578287,-pi) q[30];
cx q[0],q[30];
cx q[1],q[30];
cx q[2],q[30];
cx q[3],q[30];
...
cx q[28],q[30];
cx q[29],q[30];
u3(3.005579583727834,0.5667518785975814,-pi) q[31];
cx q[0],q[31];
...
cx q[0],q[1];
cx q[2],q[31];
u3(0.5002237983271179,1.999767015060173,0) q[2];
cx q[0],q[2];
cx q[1],q[2];
cx q[3],q[31];
...
cx q[3],q[4];
cx q[5],q[31];
u3(1.421066159778744,2.223831340859621,-pi) q[5];
cx q[0],q[5];
cx q[1],q[5];
cx q[2],q[5];
cx q[3],q[5];
cx q[4],q[5];
cx q[6],q[31];
u3(0.25107111292738793,0.42786778855263696,0) q[6];
cx q[0],q[6];
cx q[1],q[6];
cx q[2],q[6];
cx q[3],q[6];
...
cx q[6],q[7];
cx q[8],q[31];
u3(1.9787438939980078,-1.370054094109726,0) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[11],q[31];
u3(0.27078867528550604,0.23307107221287948,0) q[11];
cx q[12],q[31];
u3(0.7545152110842547,-0.9383535680109967,-pi) q[12];
cx q[13],q[31];
u3(1.4876032641952892,0.3970387803554365,-pi) q[13];
cx q[14],q[31];
...
cx q[19],q[31];
u3(1.6475495893366512,2.122559818136633,0) q[19];
cx q[20],q[31];
...
cx q[24],q[31];
u3(2.7798182245706533,-1.7670242931636873,-pi) q[24];
cx q[25],q[31];
...
cx q[1],q[30];
cx q[1],q[31];
u3(0.30553877447166683,0.2359818376485614,0) q[1];
cx q[0],q[1];
cx q[2],q[9];
cx q[2],q[10];
cx q[2],q[11];
...
cx q[2],q[30];
cx q[2],q[31];
u3(1.5620784562074312,0.19279853818444703,0) q[2];
cx q[0],q[2];
cx q[1],q[2];
cx q[3],q[9];
cx q[3],q[10];
...
cx q[7],q[30];
cx q[7],q[31];
u3(0.46899659967912327,-2.0855601215962745,-pi) q[7];
cx q[0],q[7];
cx q[1],q[7];
cx q[2],q[7];
cx q[3],q[7];
...
cx q[15],q[31];
u3(0.7707254079079356,-3.0086078353932617,-pi) q[15];
cx q[16],q[31];
u3(2.612574660840041,1.5737155605834614,-pi) q[16];
cx q[17],q[31];
u3(1.8293504931413658,-2.0354873082971374,-pi) q[17];
cx q[18],q[31];
...
cx q[0],q[30];
cx q[0],q[31];
u3(0.4843418804248502,-1.1944858947299792,0) q[0];
cx q[1],q[9];
cx q[1],q[10];
cx q[1],q[11];
cx q[1],q[12];
...
cx q[1],q[30];
cx q[1],q[31];
u3(1.2940236373937677,2.535075773598212,0) q[1];
cx q[2],q[9];
cx q[2],q[10];
cx q[2],q[11];
cx q[2],q[12];
...
cx q[4],q[30];
cx q[4],q[31];
u3(2.1631326718304944,-1.4181474769167721,-pi) q[4];
cx q[5],q[9];
cx q[5],q[10];
cx q[5],q[11];
cx q[5],q[12];
...
cx q[8],q[30];
cx q[8],q[31];
u3(1.1729696401663472,2.1653041649160034,-pi) q[8];
cx q[9],q[10];
cx q[9],q[11];
cx q[10],q[11];
cx q[9],q[12];
...
cx q[14],q[31];
u3(1.0718993507745564,0.07042600165420865,-pi) q[14];
cx q[15],q[31];
...
cx q[18],q[31];
u3(1.339490695275202,-1.298902584841633,0) q[18];
cx q[19],q[31];
u3(0.6552800011761167,-0.5511856618612718,-pi) q[19];
cx q[20],q[31];
u3(0.21396601218048542,-1.980035579712605,-pi) q[20];
cx q[21],q[31];
u3(1.9917795586327023,-1.0037557163359292,0) q[21];
cx q[22],q[31];
u3(0.8447578137430993,0.43524504081089965,-pi) q[22];
cx q[23],q[31];
u3(1.9495700285033721,0.3773065692100239,0) q[23];
cx q[24],q[31];
u3(0.15873805073857994,-0.0696367048895219,0) q[24];
cx q[25],q[31];
u3(0.30910229250827326,1.4374817945168523,0) q[25];
cx q[26],q[31];
u3(1.1600446359222587,-2.4209005358844617,0) q[26];
cx q[27],q[31];
u3(0.4337492777550397,2.312379833675429,0) q[27];
cx q[28],q[31];
u3(1.6177657972952681,-1.2391953389589503,0) q[28];
cx q[29],q[31];
u3(0.5429819944670389,0.8014947586766143,-pi) q[29];
cx q[30],q[31];
u3(2.87675332653696,-1.1233300099168826,0) q[30];
u3(0.8181448024797521,1.8111478864076522,0) q[31];
