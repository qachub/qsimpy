...
h q[43];
x psi[0];
cp(0.20489596539760618) psi[0],q[0];
cp(0.40979193079521237) psi[0],q[1];
cp(0.8195838615904247) psi[0],q[2];
cp(1.6391677231808495) psi[0],q[3];
cp(-3.0048498608178873) psi[0],q[4];
cp(0.27348558554381186) psi[0],q[5];
cp(0.5469711710876237) psi[0],q[6];
cp(1.0939423421752474) psi[0],q[7];
cp(2.187884684350495) psi[0],q[8];
cp(-1.907415938478597) psi[0],q[9];
cp(2.4683534302223924) psi[0],q[10];
cp(-1.3464784467348012) psi[0],q[11];
cp(-2.6929568934696024) psi[0],q[12];
cp(0.8972715202403814) psi[0],q[13];
cp(1.7945430404807627) psi[0],q[14];
cp(-2.6940992262180607) psi[0],q[15];
cp(0.8949868547434644) psi[0],q[16];
cp(1.7899737094869288) psi[0],q[17];
cp(-2.7032378882057286) psi[0],q[18];
cp(0.8767095307681287) psi[0],q[19];
cp(1.7534190615362575) psi[0],q[20];
cp(-2.7763471841070713) psi[0],q[21];
cp(0.7304909389654439) psi[0],q[22];
cp(1.4609818779308879) psi[0],q[23];
cp(2.9219637558617757) psi[0],q[24];
cp(-0.43925779545603444) psi[0],q[25];
cp(-0.8785155909120689) psi[0],q[26];
cp(-1.7570311818241378) psi[0],q[27];
cp(2.7691229435313107) psi[0],q[28];
cp(-0.7449394201169645) psi[0],q[29];
cp(-1.489878840233929) psi[0],q[30];
cp(-2.979757680467858) psi[0],q[31];
cp(0.3236699462438703) psi[0],q[32];
cp(0.6473398924877406) psi[0],q[33];
cp(1.2946797849754812) psi[0],q[34];
cp(2.5893595699509624) psi[0],q[35];
cp(-1.1044661672776617) psi[0],q[36];
cp(-2.2089323345553233) psi[0],q[37];
cp(1.8653206380689396) psi[0],q[38];
