...
h q[28];
x psi[0];
cp(3.032024413838525) psi[0],q[0];
cp(-0.2191364795025359) psi[0],q[1];
cp(-0.4382729590050718) psi[0],q[2];
cp(-0.8765459180101436) psi[0],q[3];
cp(-1.7530918360202872) psi[0],q[4];
cp(2.777001635139012) psi[0],q[5];
cp(-0.729182036901562) psi[0],q[6];
cp(-1.458364073803124) psi[0],q[7];
cp(-2.916728147606248) psi[0],q[8];
cp(0.4497290119670897) psi[0],q[9];
cp(0.8994580239341794) psi[0],q[10];
cp(1.7989160478683588) psi[0],q[11];
cp(-2.6853532114428686) psi[0],q[12];
cp(0.9124788842938494) psi[0],q[13];
cp(1.8249577685876988) psi[0],q[14];
cp(-2.6332697700041887) psi[0],q[15];
cp(1.0166457671712086) psi[0],q[16];
cp(2.033291534342417) psi[0],q[17];
cp(-2.2166022384947515) psi[0],q[18];
cp(1.8499808301900833) psi[0],q[19];
cp(-2.5832236467994196) psi[0],q[20];
cp(1.1167380135807468) psi[0],q[21];
cp(2.2334760271614935) psi[0],q[22];
cp(-1.8162332528565992) psi[0],q[23];
cp(2.650718801466388) psi[0],q[24];
