...
cu1(pi/8) q[8],q[3];
u2(0,0) q[9];
u3(0.2706419022233135,-1.367010528285625,-pi) q[10];
...
u3(1.69586486649158,-0.2872775554982576,3.1046021511484962) q[3];
...
cu1(pi/2) q[5],q[11];
u2(-pi,0) q[11];
u3(1.3907069347833174,-1.9854154655364193,-2.7269735148482703) q[8];
s q[9];
cx q[9],q[6];
...
cx q[8],q[2];
u2(-pi/2,1.670709233527103) q[2];
rzz(0.8989729695019022) q[2],q[3];
u3(1.485499739046067,-1.7469507435589022,1.8406051176064535) q[2];
u2(-1.5337904830011775,-pi/2) q[3];
u2(-pi,-pi) q[8];
...
rx(pi/2) q[1];
u2(0,3*pi/4) q[8];
u3(1.4929386729196135,-pi/2,-pi/2) q[9];
...
u3(1.0326574678052503,0,-pi/2) q[11];
ccx q[4],q[10],q[8];
u2(0,-pi) q[8];
cu1(pi/2) q[2],q[8];
u2(pi/4,-pi) q[2];
...
cu1(pi/8) q[8],q[11];
swap q[10],q[8];
u3(pi,1.5107447188575414,1.6308479347322518) q[11];
cx q[11],q[1];
