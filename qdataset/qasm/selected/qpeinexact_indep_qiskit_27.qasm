...
h q[25];
x psi[0];
cp(0.20473798333594775) psi[0],q[0];
cp(0.4094759666718955) psi[0],q[1];
cp(0.818951933343791) psi[0],q[2];
cp(1.637903866687582) psi[0],q[3];
cp(-3.007377573804422) psi[0],q[4];
cp(0.26843015957074234) psi[0],q[5];
cp(0.5368603191414847) psi[0],q[6];
cp(1.0737206382829694) psi[0],q[7];
cp(2.1474412765659388) psi[0],q[8];
cp(-1.9883027540477087) psi[0],q[9];
cp(2.3065797990841688) psi[0],q[10];
cp(-1.670025709011249) psi[0],q[11];
cp(2.9431338891570884) psi[0],q[12];
cp(-0.39691752886540965) psi[0],q[13];
cp(-0.7938350577308193) psi[0],q[14];
cp(-1.5876701154616386) psi[0],q[15];
cp(3.107845076256309) psi[0],q[16];
cp(-0.0674951546669682) psi[0],q[17];
cp(-0.1349903093339364) psi[0],q[18];
cp(-0.2699806186678728) psi[0],q[19];
cp(-0.5399612373357456) psi[0],q[20];
cp(-1.0799224746714913) psi[0],q[21];
