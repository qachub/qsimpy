...
u3(0.13038834331032634,1.8339114230470699,0) q[1];
cx q[0],q[1];
u3(2.3018560275705338,2.6249522282931705,-pi) q[2];
cx q[0],q[2];
cx q[1],q[2];
...
cx q[2],q[4];
cx q[3],q[4];
u3(1.4124389803026798,0.8932807542109362,0) q[5];
cx q[0],q[5];
cx q[1],q[5];
cx q[2],q[5];
cx q[3],q[5];
...
cx q[5],q[7];
cx q[6],q[7];
u3(1.0625547235745711,2.776119709759085,0) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[9],q[11];
cx q[10],q[11];
u3(0.02480768898038398,-2.196619289836783,0) q[12];
cx q[0],q[12];
cx q[1],q[12];
cx q[2],q[12];
cx q[3],q[12];
...
cx q[10],q[12];
cx q[11],q[12];
u3(3.0649864034230183,0.6348464674842362,-pi) q[13];
cx q[0],q[13];
cx q[1],q[13];
cx q[2],q[13];
cx q[3],q[13];
...
cx q[0],q[15];
u3(0.5739760098973873,-1.0963427134462451,-pi) q[0];
cx q[1],q[15];
...
cx q[6],q[7];
cx q[8],q[15];
u3(2.842600017892846,3.0638412193099116,-pi) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[9],q[15];
cx q[10],q[15];
u3(1.2500242582094414,-1.0925023928214674,0) q[10];
cx q[11],q[15];
u3(0.8994360763247733,-1.5621623869350083,-pi) q[11];
cx q[12],q[15];
u3(2.2094986973106154,-2.5297885440896417,0) q[12];
cx q[13],q[15];
u3(1.5415940196621947,2.5310665977809697,-pi) q[13];
cx q[14],q[15];
u3(1.8595822481541888,-2.9244586574319644,0) q[14];
u3(0.7292486063206927,0.5667518785975818,-pi) q[15];
u3(1.1354532936221053,-0.2745466276846109,-pi) q[9];
cx q[0],q[9];
cx q[0],q[10];
cx q[0],q[11];
cx q[0],q[12];
...
cx q[3],q[14];
cx q[3],q[15];
u3(1.919261270863872,1.6475495893366512,0) q[3];
cx q[0],q[3];
cx q[1],q[3];
cx q[2],q[3];
cx q[4],q[9];
...
cx q[6],q[14];
cx q[6],q[15];
u3(0.25107111292738793,1.904198228238804,0) q[6];
cx q[0],q[6];
cx q[1],q[6];
cx q[2],q[6];
cx q[3],q[6];
...
cx q[8],q[14];
cx q[8],q[15];
u3(1.9787438939980078,-2.7798182245706524,0) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[12],q[15];
u3(0.754515211084255,-2.7378913330613686,-pi) q[12];
cx q[13],q[15];
u3(1.4876032641952892,3.008509421420701,-pi) q[13];
cx q[14],q[15];
u3(0.7659413833270341,-1.0071453217107083,-pi) q[14];
u3(2.6232873181840106,3.110482283900007,0) q[15];
u3(2.28399350890765,0.41159274487845465,-pi) q[9];
cx q[0],q[9];
cx q[0],q[10];
cx q[0],q[11];
cx q[0],q[12];
...
cx q[2],q[14];
cx q[2],q[15];
u3(1.999767015060173,0.3171605554522552,0) q[2];
cx q[3],q[9];
cx q[3],q[10];
cx q[3],q[11];
cx q[3],q[12];
...
cx q[4],q[14];
cx q[4],q[15];
u3(2.650646985396806,-2.4626079442235436,-pi) q[4];
cx q[5],q[9];
cx q[5],q[10];
cx q[5],q[11];
cx q[5],q[12];
...
cx q[5],q[14];
cx q[5],q[15];
u3(0.9177613127301721,-2.017513155362756,-pi) q[5];
cx q[6],q[9];
cx q[6],q[10];
cx q[6],q[11];
cx q[6],q[12];
...
cx q[13],q[15];
u3(2.7445538732343566,0.6173585901279655,-pi) q[13];
cx q[14],q[15];
