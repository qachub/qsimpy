...
h q[29];
x psi[0];
cp(-2.6929568949325207) psi[0],q[0];
cp(0.8972715173145451) psi[0],q[1];
cp(1.7945430346290903) psi[0],q[2];
cp(-2.6940992379214057) psi[0],q[3];
cp(0.8949868313367751) psi[0],q[4];
cp(1.7899736626735503) psi[0],q[5];
cp(-2.7032379818324856) psi[0],q[6];
cp(0.8767093435146146) psi[0],q[7];
cp(1.7534186870292292) psi[0],q[8];
cp(-2.776347933121128) psi[0],q[9];
cp(0.7304894409373308) psi[0],q[10];
cp(1.4609788818746616) psi[0],q[11];
cp(2.9219577637493233) psi[0],q[12];
cp(-0.4392697796809398) psi[0],q[13];
cp(-0.8785395593618796) psi[0],q[14];
cp(-1.757079118723759) psi[0],q[15];
cp(2.769027069732068) psi[0],q[16];
cp(-0.7451311677154502) psi[0],q[17];
cp(-1.4902623354309004) psi[0],q[18];
cp(-2.9805246708618007) psi[0],q[19];
cp(0.32213596545598466) psi[0],q[20];
cp(0.6442719309119693) psi[0],q[21];
cp(1.2885438618239387) psi[0],q[22];
cp(2.5770877236478773) psi[0],q[23];
cp(-1.1290098598838318) psi[0],q[24];
cp(-2.2580197197676637) psi[0],q[25];
