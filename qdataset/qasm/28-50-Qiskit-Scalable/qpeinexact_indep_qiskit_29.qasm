...
h q[27];
x psi[0];
cp(3.032024407986853) psi[0],q[0];
cp(-0.21913649120588052) psi[0],q[1];
cp(-0.43827298241176105) psi[0],q[2];
cp(-0.8765459648235221) psi[0],q[3];
cp(-1.7530919296470442) psi[0],q[4];
cp(2.777001447885498) psi[0],q[5];
cp(-0.7291824114085903) psi[0],q[6];
cp(-1.4583648228171806) psi[0],q[7];
cp(-2.916729645634361) psi[0],q[8];
cp(0.44972601591086336) psi[0],q[9];
cp(0.8994520318217267) psi[0],q[10];
cp(1.7989040636434535) psi[0],q[11];
cp(-2.6853771798926793) psi[0],q[12];
cp(0.9124309473942279) psi[0],q[13];
cp(1.8248618947884558) psi[0],q[14];
cp(-2.6334615176026746) psi[0],q[15];
cp(1.0162622719742374) psi[0],q[16];
cp(2.0325245439484747) psi[0],q[17];
cp(-2.2181362192826373) psi[0],q[18];
cp(1.846912868614312) psi[0],q[19];
cp(-2.5893595699509624) psi[0],q[20];
cp(1.1044661672776617) psi[0],q[21];
cp(2.2089323345553233) psi[0],q[22];
cp(-1.8653206380689396) psi[0],q[23];
