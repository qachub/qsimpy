...
h q[24];
x psi[0];
cp(-2.692957014891803) psi[0],q[0];
cp(0.8972712773959801) psi[0],q[1];
cp(1.7945425547919602) psi[0],q[2];
cp(-2.6941001975956658) psi[0],q[3];
cp(0.8949849119882551) psi[0],q[4];
cp(1.7899698239765103) psi[0],q[5];
cp(-2.7032456592265657) psi[0],q[6];
cp(0.8766939887264547) psi[0],q[7];
cp(1.7533879774529093) psi[0],q[8];
cp(-2.7764093522737676) psi[0],q[9];
cp(0.7303666026320509) psi[0],q[10];
cp(1.4607332052641018) psi[0],q[11];
cp(2.9214664105282036) psi[0],q[12];
cp(-0.440252486123179) psi[0],q[13];
cp(-0.880504972246358) psi[0],q[14];
cp(-1.761009944492716) psi[0],q[15];
cp(2.761165418194154) psi[0],q[16];
cp(-0.760854470791278) psi[0],q[17];
cp(-1.521708941582556) psi[0],q[18];
cp(-3.043417883165112) psi[0],q[19];
cp(pi/16) psi[0],q[20];
cp(pi/8) psi[0],q[21];
cp(pi/4) psi[0],q[22];
cp(pi/2) psi[0],q[23];
