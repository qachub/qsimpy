...
h q[24];
x psi[0];
cp(-2.692956921265046) psi[0],q[0];
cp(0.8972714646494944) psi[0],q[1];
cp(1.7945429292989887) psi[0],q[2];
cp(-2.6940994485816088) psi[0],q[3];
cp(0.8949864100163683) psi[0],q[4];
cp(1.7899728200327365) psi[0],q[5];
cp(-2.7032396671141132) psi[0],q[6];
cp(0.87670597295136) psi[0],q[7];
cp(1.75341194590272) psi[0],q[8];
cp(-2.7763614153741463) psi[0],q[9];
cp(0.7304624764312938) psi[0],q[10];
cp(1.4609249528625876) psi[0],q[11];
cp(2.9218499057251752) psi[0],q[12];
cp(-0.4394854957292362) psi[0],q[13];
cp(-0.8789709914584724) psi[0],q[14];
cp(-1.7579419829169447) psi[0],q[15];
cp(2.767301341345697) psi[0],q[16];
cp(-0.7485826244881929) psi[0],q[17];
cp(-1.4971652489763858) psi[0],q[18];
cp(-2.9943304979527716) psi[0],q[19];
cp(0.2945243112740431) psi[0],q[20];
