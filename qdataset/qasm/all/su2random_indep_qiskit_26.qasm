...
qreg q[26];
creg meas[26];
u3(1.4368347742816616,0.7399517487893483,-pi) q[0];
...
cx q[2],q[4];
cx q[3],q[4];
u3(1.4124389803026796,-3.005579583727833,0) q[5];
cx q[0],q[5];
cx q[1],q[5];
cx q[2],q[5];
cx q[3],q[5];
...
cx q[5],q[7];
cx q[6],q[7];
u3(1.0625547235745711,0.5683728542359914,0) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[8],q[10];
cx q[9],q[10];
u3(0.2928382424047807,2.0651656802006935,-pi) q[11];
cx q[0],q[11];
cx q[1],q[11];
cx q[2],q[11];
cx q[3],q[11];
...
cx q[14],q[16];
cx q[15],q[16];
u3(1.8339114230470697,-0.899436076324772,0) q[17];
cx q[0],q[17];
cx q[1],q[17];
cx q[2],q[17];
cx q[3],q[17];
...
cx q[18],q[20];
cx q[19],q[20];
u3(0.8932807542109366,-0.7292486063206916,0) q[21];
cx q[0],q[21];
cx q[1],q[21];
cx q[2],q[21];
cx q[3],q[21];
...
cx q[1],q[25];
u3(0.9497161489686776,2.62328731818401,0) q[1];
cx q[0],q[1];
cx q[2],q[25];
...
cx q[6],q[7];
cx q[8],q[25];
u3(2.529788544089642,-1.2373944253509892,-pi) q[8];
cx q[0],q[8];
cx q[1],q[8];
cx q[2],q[8];
cx q[3],q[8];
...
cx q[12],q[25];
u3(0.24681462267060233,2.9853439559254618,0) q[12];
cx q[13],q[25];
...
cx q[17],q[25];
u3(1.4210661597787437,-0.03111036968978631,-pi) q[17];
cx q[18],q[25];
u3(0.251071112927388,-0.1440060461338284,0) q[18];
cx q[19],q[25];
...
cx q[24],q[25];
u3(0.7545152110842546,-2.7137248650371566,-pi) q[24];
u3(1.4876032641952892,-0.22285950741842697,-pi) q[25];
...
cx q[0],q[24];
cx q[0],q[25];
u3(1.3700540941097261,-1.579514197382362,-pi) q[0];
cx q[1],q[9];
cx q[1],q[10];
cx q[1],q[11];
cx q[1],q[12];
...
cx q[5],q[24];
cx q[5],q[25];
u3(2.7445538732343566,2.67259605391067,-pi) q[5];
cx q[0],q[5];
cx q[1],q[5];
cx q[2],q[5];
cx q[3],q[5];
...
cx q[9],q[25];
cx q[10],q[25];
u3(0.31716055545225547,-2.682738516769051,0) q[10];
cx q[11],q[25];
u3(2.1225598181366325,-1.3084293813176604,0) q[11];
cx q[12],q[25];
u3(0.6789847093662497,-2.7548163519525515,0) q[12];
cx q[13],q[25];
...
cx q[18],q[25];
u3(0.6715442342991345,-1.9233454375390764,0) q[18];
cx q[19],q[25];
u3(1.6047051650602804,-2.4842474119629205,-pi) q[19];
cx q[20],q[25];
u3(2.951748053274365,2.7621211709444955,0) q[20];
cx q[21],q[25];
u3(2.5242340634618277,-2.097313761110976,-pi) q[21];
cx q[22],q[25];
u3(0.9275250232100075,-3.0977446327336775,0) q[22];
cx q[23],q[25];
u3(1.156324890185097,-1.137031199585799,0) q[23];
cx q[24],q[25];
u3(2.2300776000832374,-2.5754353418912723,-pi) q[24];
...
cx q[21],q[25];
u3(1.1061053452926557,-0.8515023383206994,0) q[21];
cx q[22],q[25];
